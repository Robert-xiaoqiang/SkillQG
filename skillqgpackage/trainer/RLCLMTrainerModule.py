...
from .TrainerModuleCommon import TrainerModuleCLMMixin, TrainerModuleRLMixin

class RLCLMTrainerModule(BaseTrainerModule, TrainerModuleCLMMixin, TrainerModuleRLMixin):
